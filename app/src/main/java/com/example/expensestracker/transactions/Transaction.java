...
public class Transaction
{
    ...
    public Transaction(BudgetCategory budgetCategory, String productName, double price, Date buyDate) {
    ...
    public boolean equals(Object o) {
        ...
        if (getBudgetCategory() != null ? !getBudgetCategory().equals(that.getBudgetCategory()) : that.getBudgetCategory() != null)
            return false;
    ...
    public int hashCode() {
        int result;
        long temp;
        result = getBudgetCategory() != null ? getBudgetCategory().hashCode() : 0;
